...
SYSTEM_PROMPT = (
    ...
    "      'Antidote', 'Antidote AI', 'Antido', 'Android AI', 'AI', 'AI agent',\n"
    "      'fact checker', 'back checker', 'hey AI', 'please respond',\n"
    "      'can you check', 'can you fact check', 'do you have info on',\n"
    "      'is that right', 'is that true', or any equivalent — counts.\n"
    "      Be very generous: if a participant pauses and looks to the AI to\n"
    "      adjudicate something just said, that is a direct address.\n"
